...
class _MyAppState extends State<MyApp> {
  ...
  Future<bool> _isUserLoggedIn() async {
    print("In UserloggedIn function");
                                                        ...
                                                        children: <Widget>[
                                                          Center(
                                                            child: Column(children: [
                                                              ...
                                                              SizedBox(height: 20,),
                                                              Text(_pendingPostMessage ,style: TextStyle(color: Colors.white),)
                                                            ]),
                                                          )
                                                        ]);
                                                  }
                                                ...
                                                children: <Widget>[
                                                  Center(
                                                    child: Column(children: [
                                                      CircularProgressIndicator(),
                                                      SizedBox(height: 20,),
                                                      Text("Checking Pending Posts",style: TextStyle(color: Colors.white),)
                                                    ]),
                                                  )
                                                ]);
                                          }
